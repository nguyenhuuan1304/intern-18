...
const ShoppingCartMobile = ({show} : {show : boolean}) => {
  ...
  return (
    <div className={`lg:hidden sm:hidden shoppingMobile ${show ? "show1" : ""}`}>
        <div className='bg-[#0f35c4] text-[#fff] h-[60px] w-full flex relative'>
            <h1 className='text-[22px] font-[500] line-[20px] w-[90%] items-center m-[auto] text-center'>GIỎ HÀNG</h1>
            <div className='absolute right-[16px] bottom-[24px]'>
                <X/>
            </div>
        </div>
        <div className='h-[60px] flex items-center justify-center mt-[120px] bg-white'>
