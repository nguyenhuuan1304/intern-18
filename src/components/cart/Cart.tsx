    ...
    const [cart] = useState<CartItem[]>([
        {
            ...
            size: 42,
            price: 185000,
            image: "https://cdn2-retail-images.kiotviet.vn/2025/03/11/locsporthcm/607e3eae5220486688933ece430ca567.jpg"
        },
        {
            id: 2,
            ...
            size: 41,
            price: 190000,
            image: "https://cdn2-retail-images.kiotviet.vn/2025/03/11/locsporthcm/some-other-image.jpg"
        }
    ]);
        ...
        <>
            ...
            <div className="flex flex-col md:flex-row p-4">
                ...
                <div className="w-full md:w-1/3 p-4 bg-gray-100 shadow-lg">
                    ...
                    <div className="flex justify-between mb-4">
                        <span>Tổng tiền</span>
                        <span className="font-bold text-red-500">{totalPrice.toLocaleString()}₫</span>
                    </div>
                    <button
